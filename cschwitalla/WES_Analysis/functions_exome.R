...
compute_vaf <- function(maf_obj){
  genes_vaf = subsetMaf(maf = maf_obj, query = "t_depth > 0", 
                        fields = c("t_depth","t_alt_count"), mafObj = FALSE)
  #print(genes_vaf$t_alt_count)
...
patientcolor2 <- setNames(c("#543005", "#8c510a", "#A6691C", "#bf812d", "#CFA255", 
                          ...
                          c("ZH0984", "ZH0991", "ZH0997", "ZH1002", "ZH1006", "ZH1007",
...
annotation_color <- list(Tumor_region = regioncolor, Patient_ID = patientcolor2)
